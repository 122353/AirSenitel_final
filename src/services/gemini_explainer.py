...
def explain_case(case: dict) -> tuple[str, str]:
    ...
    if gemini_enabled:
        ...
        explanation = f"Automated explanation for case {case.get('case_id')}. Anomaly category: {case.get('case_category', 'Unknown')}. Observed: {case.get('observed_pm25')}, Predicted: {case.get('predicted_pm25')}. Supporting evidence remains unverified; human review required."
